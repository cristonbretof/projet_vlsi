...
proc create_root_design { parentCell } {
  ...
  set ctrl [ create_bd_port -dir I ctrl ]
  set hdmi_in_hpd [ create_bd_port -dir O -from 0 -to 0 hdmi_in_hpd ]
  set key [ create_bd_port -dir I -from 2 -to 0 key ]
  ...
  connect_bd_net -net ctrl_1 [get_bd_ports ctrl] [get_bd_pins pixel16_0/ctrl_in]
  ...
  connect_bd_net -net key_1 [get_bd_ports key] [get_bd_pins pixel16_0/key_in]
  ...
  connect_bd_net -net start_1 [get_bd_ports start] [get_bd_pins pixel16_0/start_in]
