...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/ALCLO68/Documents/projet_vlsi-main/projet_vlsi-main/SerpentEncryption/FSM_HDMI_Encrypt/ZYBO_HDMI_MGA_2018_2/project_1/project_1.cache/compile_simlib/modelsim"
  fi
